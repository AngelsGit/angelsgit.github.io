...
var commands = {
    ...
    whoami: function() {
        this.echo("I am passionate about web development as well as low level programming like working on Kernels for Operating Systems. \n" +
            ...
            " at Both: " + hotpink("Dell Technlogies") + " & " + hotpink("LaunchGood") + "I am now a" + green(" full-time Software Engineer") + " @ " + hotpink("NextEra Energy.") + " I graduated with my \n" + green("Bachelor's in Computer" +
            " Science") + " from " + blue("Florida International"
